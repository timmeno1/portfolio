...
export const Portfolio = () => {
  return (
    <section
      id={"portfolio"}
      className="container  p-2 md:p-4 min-h-screen "
    >
      <h3 className=" text-2xl uppercase text-center mb-4">Porfolio</h3>
      <div className="grid justify-items-stretch grid-cols-8 md:grid-cols-12 gap-6">
        { portfolioData.map((el, i, arr) => {
          ...
          return (
            <div key={i} className={"relative group h-64  hover:ring hover:ring-teal-200 transition-all duration-300 overflow-hidden rounded-md"} style={{gridColumn:cardSpan}}>
